...
impl std::str::FromStr for CryptoHash {
  ...
  fn from_str(input: &str) -> Result<CryptoHash, Self::Err> {
      match input {
          "SHA-1"  => Ok(CryptoHash::Sha1),
          "SHA-256"  => Ok(CryptoHash::Sha256),
          "SHA-384"  => Ok(CryptoHash::Sha384),
          "SHA-512" => Ok(CryptoHash::Sha512),
          _      => Err(()),
      }
  }
}
